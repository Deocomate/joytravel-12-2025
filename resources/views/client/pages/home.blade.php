...
@section('content')
    ...
    <section
        ...
        <div class="relative z-30 container mx-auto px-4 text-center pt-20 md:pt-24 lg:pt-28">
            <div class="hero-content max-w-4xl mx-auto">
                {{-- Badge --}}
                <div
                    class="hero-badge inline-flex items-center gap-2 px-3 py-1.5 md:px-4 md:py-2 rounded-full bg-white/10 backdrop-blur-md border border-white/20 text-white mb-4 md:mb-6">
                    <span class="w-2 h-2 bg-green-400 rounded-full animate-pulse"></span>
                    <span class="text-xs md:text-sm font-medium">🎉 Ưu đãi đặc biệt cuối năm - Giảm đến 30%</span>
                </div>
        ...
        <div class="container mx-auto px-4 relative z-10">
            <div class="grid grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6 lg:gap-8 xl:gap-12">
                ...
                <div class="stat-item text-center" data-aos="zoom-in" data-aos-delay="200">
                    ...
                    <div class="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-black text-white mb-1 md:mb-2">
                        <span class="stat-number" data-count="{{ ($statistics['total_customers'] ?? 0) + 1000 }}">0</span>+
                    </div>
    ...
    @if(!empty($featuredTours) && $featuredTours->count() > 0)
        <section class="py-12 md:py-16 lg:py-24 bg-white">
            <div class="container mx-auto px-4">
                {{-- Section Header --}}
                <div class="flex flex-col md:flex-row md:items-end justify-between mb-6 md:mb-8 lg:mb-10" data-aos="fade-up">
                    <div>
                        <span
                        ...
                        <section data-aos="fade-up" data-aos-delay="{{ $categoryIndex * 100 }}">
                            <div class="flex flex-col md:flex-row md:items-end justify-between mb-6 md:mb-8">
                                <div>
                                    ...
                                    <div class="mt-2 w-16 md:w-24 h-1 bg-gradient-to-r from-primary to-transparent rounded-full"></div>
                                </div>
                            </div>
                ...
                @foreach($testimonials as $index => $testimonial)
                    <div class="testimonial-card bg-white/5 backdrop-blur-sm rounded-xl md:rounded-2xl p-5 md:p-6 lg:p-8 border border-white/10 hover:bg-white/10 transition-all duration-300"
                        ...
                        <div class="flex items-center gap-3 md:gap-4">
                            ...
                            <div>
                                <p class="text-white font-semibold text-sm md:text-base">{{ $testimonial['name'] }}</p>
        ...
        document.addEventListener('DOMContentLoaded', () => {
                ...
                on: {
                    slideChange: function () {
                        ...
                        if (bg) {
                            ...
                            setTimeout(() => { bg.style.transform = 'scale(1.1)'; }, 100);
                        }
                    }
                }
            });
            ...
            if (typeof gsap !== 'undefined') {
                ...
                heroTl
                    ...
                    .to('.hero-typing', { opacity: 1, y: 0, duration: 0.6, ease: 'power3.out' }, '-=0.4')
                    ...
                    .to('.hero-search', { opacity: 1, y: 0, duration: 0.8, ease: 'power3.out' }, '-=0.2');

                // Set initial states
                gsap.set(['.hero-badge', '.hero-title', '.hero-typing', '.hero-description', '.hero-cta', '.hero-search'], {
                    y: 30
                });
            }
