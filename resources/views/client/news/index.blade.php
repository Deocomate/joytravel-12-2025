...
@section('description', 'Cập nhật những tin tức du lịch mới nhất, kinh nghiệm du lịch hữu ích và các chương trình khuyến
    mãi hấp dẫn từ King Express Travel.')
            ...
            <div class="grid grid-cols-1 lg:grid-cols-12 gap-8">
                <div class="lg:col-span-9 order-2 lg:order-1">
                    <div id="news-list-container" class="space-y-6">
                        @include('client.news.partials.news_list', ['newsItems' => $newsItems])
                    </div>
            ...
            paginationContainer.addEventListener('click', function(e) {
                ...
                if (loadMoreButton && !loadMoreButton.disabled) {
                    ...
                    fetch(url, {
                        ...
                        .then(data => {
                            if (data.html) {
                                const newsListContainer = document.getElementById(
                                'news-list-container');
