...
@section('title', 'Đăng nhập - King Express Travel')
            ...
            <div class="max-w-md mx-auto">
                ...
                <div class="bg-white rounded-2xl shadow-xl p-8 border border-gray-100 relative overflow-hidden">
                    ...
                    <div class="text-center mb-8 relative z-10">
                        ...
                        <h1 class="text-3xl font-black text-gray-800">Đăng Nhập</h1>
                        <p class="text-gray-500 mt-2">Chào mừng bạn quay trở lại!</p>
                    </div>

                    {{-- Form --}}
                    <form action="{{ route('client.login.submit') }}" method="POST" class="space-y-5 relative z-10">
                        @csrf
                        ...
                        <div class="flex justify-between items-center text-sm">
                            <label class="flex items-center gap-2 cursor-pointer group">
                                ...
                                <span class="text-gray-600 group-hover:text-gray-800 transition-colors">Ghi nhớ đăng
                                    nhập</span>
                            </label>
                    ...
                    <a href="{{ route('auth.google.redirect') }}"
                        class="w-full flex items-center justify-center gap-3 py-3 border-2 border-gray-200 rounded-xl hover:bg-gray-50 hover:border-gray-300 transition-all font-medium text-gray-700 group">
                        ...
                        <span class="group-hover:text-gray-900 transition-colors">Đăng nhập với Google</span>
                    </a>
                </div>
