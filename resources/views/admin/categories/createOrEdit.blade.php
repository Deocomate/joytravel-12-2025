    ...
    <div class="card card-primary">
        ...
        <form
            ...
            <div class="card-body">
                ...
                <x-admin.inputs.text label="Tên Danh mục" name="name" :value="old('name', $category->name ?? '')" :required="true"/>

                <x-admin.inputs.image-link label="Ảnh đại diện" name="thumbnail" :value="old('thumbnail', $category->thumbnail ?? '')"/>

                <div class="row">
                    <div class="col-md-6">
                        <x-admin.inputs.select label="Danh mục cha" name="parent_id">
