    ...
    <div class="card card-primary">
        ...
        <form
            ...
            <div class="card-body">
                ...
                <x-admin.inputs.text label="Tiêu đề" name="title" :value="old('title', $news->title ?? '')"
                               :required="true"/>

                <div class="row">
                    <div class="col-md-6">
                        <x-admin.inputs.select label="Danh mục" name="category_id" :required="true">
                ...
                <x-admin.inputs.editor label="Nội dung" name="contents" :value="old('contents', $news->contents ?? '')"/>
            </div>
