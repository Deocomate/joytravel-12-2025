    ...
    <svg class="w-full h-20 md:h-28 -mb-1" viewBox="0 0 1440 100" preserveAspectRatio="none">
        ...
        <path fill="url(#footer-wave-gradient)"
            ...
            <animate attributeName="d"
                values="M0,60 C360,100 720,20 1080,60 C1260,80 1380,50 1440,40 L1440,100 L0,100 Z; M0,40 C360,20 720,80 1080,40 C1260,20 1380,60 1440,50 L1440,100 L0,100 Z; M0,60 C360,100 720,20 1080,60 C1260,80 1380,50 1440,40 L1440,100 L0,100 Z"
                dur="8s" repeatCount="indefinite" />
        </path>
        <path fill="#ffffff" opacity="0.6"
            d="M0,80 C400,40 800,90 1200,50 C1320,40 1380,60 1440,55 L1440,100 L0,100 Z">
            <animate attributeName="d"
                values="M0,80 C400,40 800,90 1200,50 C1320,40 1380,60 1440,55 L1440,100 L0,100 Z; M0,70 C400,90 800,40 1200,70 C1320,80 1380,50 1440,60 L1440,100 L0,100 Z; M0,80 C400,40 800,90 1200,50 C1320,40 1380,60 1440,55 L1440,100 L0,100 Z"
    ...
    <div class="container mx-auto px-4 py-12 md:py-16 relative z-10">
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10 lg:gap-12 stagger-children">
            ...
            <div class="reveal-up" data-aos="fade-up" data-aos-delay="100">
                ...
                <ul class="space-y-3 text-sm">
                    <li><a href="#"
                            class="group flex items-center text-gray-600 hover:text-[var(--color-primary)] transition-all"><i
                                class="fa-solid fa-chevron-right text-xs mr-2 opacity-0 -translate-x-2 group-hover:opacity-100 group-hover:translate-x-0 transition-all text-[var(--color-primary)]"></i><span
                                class="group-hover:translate-x-1 transition-transform">Chính sách đặt tour</span></a>
                    </li>
                    <li><a href="#"
                            class="group flex items-center text-gray-600 hover:text-[var(--color-primary)] transition-all"><i
                                class="fa-solid fa-chevron-right text-xs mr-2 opacity-0 -translate-x-2 group-hover:opacity-100 group-hover:translate-x-0 transition-all text-[var(--color-primary)]"></i><span
                                class="group-hover:translate-x-1 transition-transform">Chính sách bảo mật</span></a>
                    </li>
                    <li><a href="{{ route('client.contact') }}"
                            class="group flex items-center text-gray-600 hover:text-[var(--color-primary)] transition-all"><i
                                class="fa-solid fa-chevron-right text-xs mr-2 opacity-0 -translate-x-2 group-hover:opacity-100 group-hover:translate-x-0 transition-all text-[var(--color-primary)]"></i><span
                                class="group-hover:translate-x-1 transition-transform">Phiếu góp ý</span></a></li>
                </ul>
                <h3
                ...
                <div class="flex items-center gap-x-3">
                    <a href="{{ optional($contactInfo)->facebook ?? '#' }}" target="_blank"
                        class="social-icon flex items-center justify-center h-11 w-11 bg-gradient-to-br from-gray-100 to-gray-200 rounded-xl text-gray-600 hover:from-blue-500 hover:to-blue-600 hover:text-white shadow-sm hover:shadow-lg hover:shadow-blue-500/30"><i
                            class="fa-brands fa-facebook-f text-lg"></i></a>
                    <a href="#"
                        class="social-icon flex items-center justify-center h-11 w-11 bg-gradient-to-br from-gray-100 to-gray-200 rounded-xl text-gray-600 hover:from-red-500 hover:to-red-600 hover:text-white shadow-sm hover:shadow-lg hover:shadow-red-500/30"><i
                            class="fa-brands fa-youtube text-lg"></i></a>
                    <a href="https://zalo.me/{{ optional($contactInfo)->zalo ?? '' }}" target="_blank"
                        class="social-icon flex items-center justify-center h-11 w-11 bg-gradient-to-br from-gray-100 to-gray-200 rounded-xl text-gray-600 hover:from-blue-400 hover:to-blue-500 hover:text-white shadow-sm hover:shadow-lg hover:shadow-blue-400/30"><span
                            class="font-bold text-sm">Zalo</span></a>
                </div>
            </div>
                ...
                <div class="flex flex-wrap items-center gap-3">
                    <div class="bg-white p-3 rounded-xl shadow-sm hover:shadow-md transition-all hover:-translate-y-1">
                        <img src="https://cdn.haitrieu.com/wp-content/uploads/2022/10/Logo-VNPAY-QR-1.png"
                            alt="VNPAY" class="h-7" loading="lazy">
                    </div>
                    <div class="bg-white p-3 rounded-xl shadow-sm hover:shadow-md transition-all hover:-translate-y-1">
            ...
            <div class="reveal-up" data-aos="fade-up" data-aos-delay="300">
                ...
                <p class="text-sm text-gray-600 mb-4">Đăng ký để nhận ưu đãi độc quyền!</p>
                <form action="#" method="POST">
                    <div class="relative group">
                        ...
                        <button type="submit"
                            ...
                            aria-label="Đăng ký"><i class="fa-solid fa-paper-plane text-sm"></i></button>
                    </div>
                </form>
            </div>
        </div>
        ...
        <div class="border-t border-gray-200 mt-12 pt-8">
            <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6">
                <div class="text-sm text-gray-600">
                    <h4 class="font-bold text-gray-700 uppercase text-xs tracking-wider mb-2 flex items-center gap-2">
                        <i class="fa-solid fa-id-card text-[var(--color-primary)]"></i> Giấy phép kinh doanh dịch vụ lữ
                        hành quốc tế
                    </h4>
                    <p class="text-gray-500">Số GP/ No: 79-042/2022/ TCDL - GP LHQT | Do TCDL cấp ngày 30/11/2009</p>
                </div>
            ...
            <div
                ...
                <p class="text-xs text-gray-400">Copyright © {{ date('Y') }} <span
                        class="font-semibold text-gray-500">{{ optional($contactInfo)->company_name ?? 'King Express Travel' }}</span>.
                    All rights reserved.</p>
                <p class="text-xs text-gray-400">Ghi rõ nguồn "<span
                        class="text-[var(--color-primary)]">{{ request()->getHost() }}</span>" khi sử dụng thông tin
                    từ website này.</p>
            </div>
        </div>
    </div>
